...
Quest2 = GetQuestStatus(UID,1207); --18005
	if (Quest1 == 1 and Quest2 ~= 2) then
		SelectMsg(UID,3,-1,101,NPC,40154,202,4262,900,4554,910,8209,920,7591,930,7746,940,7785,950,7799,960,3019,-1);
	else
		SelectMsg(UID,3,-1,101,NPC,4262,900,4554,910,8209,920,7591,930,7746,940,7785,950,7799,960,3019,-1);
	end
end
