...
if (Level > 34 and Level < 60) then---35 levelden 59 level arası
        SelectMsg(UID, 2, -1, 4134, NPC, 4075, 180, 4076, 169);
elseif (Level > 59 and Level < 84) then---60 levelden 83 level arası
        SelectMsg(UID, 2, -1, 4133, NPC, 4075, 190, 4076, 169); 
else
...
SelectMsg(UID, 2, -1, 4133, NPC, 4075, 181, 4076, 169); 
elseif (Time == 19) then----saat 19 ise
SelectMsg(UID, 2, -1, 4133, NPC, 4075, 182, 4076, 169); 
...
SelectMsg(UID, 2, -1, 4133, NPC, 4075, 191, 4076, 169); 
elseif (Time == 22) then----saat 22 ise
SelectMsg(UID, 2, -1, 4133, NPC, 4075, 192, 4076, 169); 
else--Zamanı gelmedi ise
