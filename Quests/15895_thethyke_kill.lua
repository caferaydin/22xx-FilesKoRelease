...
-----------------------------------------------------
if (EVENT == 116) then
	MonsterCount = QuestMonsterCount(UID, 1604, 1);
...
-----------------------------------------------------
if (EVENT == 136) then
	MonsterCount = QuestMonsterCount(UID, 1605, 1);
	if (MonsterCount < 0) then
...
-----------------------------------------------------
if (EVENT == 156) then
	MonsterCount = QuestMonsterCount(UID, 1606, 1);
	if (MonsterCount < 0) then
