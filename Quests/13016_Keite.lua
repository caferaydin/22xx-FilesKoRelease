...
if (EVENT == 500) then--800
	SelectMsg(UID, 3, -1, 4834, NPC, 40965, 608, 4263, 101, 4264, 102, 4265, 103, 7493,3002, 4337, 104, 4199, 3001);
end
...
if (EVENT == 606) then
	MonsterCount = QuestMonsterCount(UID, 525, 1);
