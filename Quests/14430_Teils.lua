...
if (EVENT == 8615) then
	MonsterCount  = QuestMonsterCount(UID, 153, 1);
...
if (EVENT == 8276) then
	MonsterCount = QuestMonsterCount(UID, 181, 1);
	if (MonsterCount < 0) then
...
if (EVENT == 8506) then
	MonsterCount = QuestMonsterCount(UID, 198, 1);
	if (MonsterCount < 0) then
...
if (EVENT == 8077) then
	MonsterCount = QuestMonsterCount(UID, 209, 1);
	if (MonsterCount < 0) then
...
if (EVENT == 8157) then
	MonsterCount = QuestMonsterCount(UID, 213, 1);
	if (MonsterCount < 0) then
...
if (EVENT == 9476) then
	MonsterCount = QuestMonsterCount(UID, 222, 1);
	if (MonsterCount < 0) then
...
if (EVENT == 8552) then
	...
	if (MonsterSub == 0) then
		...
		SelectMsg(UID, 2, 230, 8406, NPC, 10, 153);
	end
end
...
if (EVENT == 8555) then
	SelectMsg(UID, 2, 230, 8008, NPC, 3014, 153);
	SaveEvent(UID, 9054);
end

if (EVENT == 8557) then
	MonsterCount = QuestMonsterCount(UID, 230, 1);
	if (MonsterCount < 0) then
		SelectMsg(UID, 2, 230, 8409, NPC, 18, 8558);
	else
		SelectMsg(UID, 5, 230, 8012, NPC, 41, 8559, 27, 153);
	end
end
...
if (EVENT == 9496) then
	MonsterCount = QuestMonsterCount(UID, 232, 1);
	if (MonsterCount < 0) then
...
if (EVENT == 402) then
	...
	if (MonsterSub == 0) then
		...
		SelectMsg(UID, 2, 470, 8168, NPC, 10, 153);
	end
end
...
if (EVENT == 407) then
	MonsterCount = QuestMonsterCount(UID, 470, 1);
	if (MonsterCount < 0) then
...
if (EVENT == 9002) then
	...
	if (MonsterSub == 0) then
		...
		SelectMsg(UID, 2, 240, 8406, NPC, 10, 153);
	end
end
...
if (EVENT == 9005) then
	SelectMsg(UID, 2, 240, 8008, NPC, 3014, 153);
	SaveEvent(UID, 9090);
end

if (EVENT == 9007) then
	MonsterCount = QuestMonsterCount(UID, 240, 1);
	if (MonsterCount < 0) then
		SelectMsg(UID, 2, 240, 8409, NPC, 18, 9008);
	else
		SelectMsg(UID, 4, 240, 8224, NPC, 41, 9009, 27, 153);
	end
end
...
if (EVENT == 1010) then
	...
	if (MonsterSub == 0) then
		...
		SelectMsg(UID, 2, 420, 844, NPC, 10, 153);
	end
end
...
if (EVENT == 1015) then
	MonsterCount = QuestMonsterCount(UID, 420, 1);
	if (MonsterCount < 0) then
...
if (EVENT == 1102) then
	...
	if (MonsterSub == 0) then
		...
		SelectMsg(UID, 2, 424, 8155, NPC, 10, 153);
	end
end
...
if (EVENT == 1106) then
	MonsterCount = QuestMonsterCount(UID, 424, 1);
	if (MonsterCount < 0) then
...
if (EVENT == 1202) then
	...
	if (MonsterSub == 0) then
		...
		SelectMsg(UID, 2, 426, 8495, NPC, 10, 153);
	end
end
...
if (EVENT == 1206) then
	MonsterCount = QuestMonsterCount(UID, 426, 1);
	if (MonsterCount < 0) then
...
if (EVENT == 1302) then
	...
	if (MonsterSub == 0) then
		...
		SelectMsg(UID, 2, 430, 8009, NPC, 10, 153);
	end
end
...
if (EVENT == 1307) then
	MonsterCount = QuestMonsterCount(UID, 430, 1);
	if (MonsterCount < 0) then
...
if (EVENT == 1402) then
	...
	if (MonsterSub == 0) then
		...
		SelectMsg(UID, 2, 432, 8160, NPC, 10, 153);
	end
end
...
if (EVENT == 1407) then
	MonsterCount = QuestMonsterCount(UID, 432, 1);
	if (MonsterCount < 0) then
...
if (EVENT == 302) then
	...
	if (MonsterSub == 0) then
		...
		SelectMsg(UID, 2, 464, 8168, NPC, 10, 153);
	end
end
...
if (EVENT == 307) then
	MonsterCount = QuestMonsterCount(UID, 464, 1);
	if (MonsterCount < 0) then
...
if(EVENT == 9900) then -- Sürekli Küpe
	MonsterSub = ExistMonsterQuestSub(UID);
	if (MonsterSub == 0) then
		SelectMsg(UID, 4, savenum, talknum, NPC, 22, 9901, 23, 153);
	else
...
if(EVENT == 9906 )then
	Class = CheckClass(UID);
	if (Class == 1 or Class == 5 or Class == 6 or Class == 13 or Class == 14 or Class == 15) then
		RunExchange(UID, 11122)
		SaveEvent(UID, 1375);
	elseif (Class == 2 or Class == 7 or Class == 8) then
		RunExchange(UID, 11123)
		SaveEvent(UID, 1378);
	elseif (Class == 3 or Class == 9 or Class == 10) then
		RunExchange(UID, 11124)
		SaveEvent(UID, 1381);
	elseif (Class == 4 or Class == 11 or Class == 12) then
		RunExchange(UID, 11125)
		SaveEvent(UID, 1384);
	end
end
...
if(EVENT == 9800) then  -- Sürekli pendat
	MonsterSub = ExistMonsterQuestSub(UID);
	if (MonsterSub == 0) then
		SelectMsg(UID, 4, savenum, talknum, NPC, 22, 9801, 23, 153);
	else
		SelectMsg(UID, 2, savenum, talknum, NPC, 10, 153);
	end
end
...
if (EVENT == 9806) then
	Class = CheckClass(UID);
	if (Class == 1 or Class == 5 or Class == 6) then
	RunExchange(UID,11134)
	SaveEvent(UID, 1435);
	elseif (Class == 2 or Class == 7 or Class == 8) then
	RunExchange(UID,11135)
	SaveEvent(UID, 1438);
	elseif (Class == 3 or Class == 9 or Class == 10) then
	RunExchange(UID,11136)
	SaveEvent(UID, 1441);
	elseif (Class == 4 or Class == 11 or Class == 12) then
	RunExchange(UID,11137)
	SaveEvent(UID, 1444);
	end
end
