...
if (EVENT == 286) then
	SelectMsg(UID, 4, 21, 4172, NPC, 4161, 287, 4162, 241);
end
...
if (EVENT == 361) then 
	...
	if (ITEM_COUNT < 1500000) then
		SelectMsg(UID, 2, 19, 4160, NPC, 10, 241);
	else
		SelectMsg(UID, 4, 19, 4157, NPC, 22, 362, 23, 241);
	end
end
...
if (EVENT == 363) then
	...
	if (ITEM_COUNT < 350000) then
		SelectMsg(UID, 2, 20, 4161, NPC, 10, 241);
	else
		SelectMsg(UID, 4, 20, 4159, NPC, 22, 364, 23, 241);
	end
end
