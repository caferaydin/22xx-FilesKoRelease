...
if (EVENT == 100) then
 SelectMsg(UID, 3, 974, 8075, NPC, 4481, 101, 8265, 102, 40621, 103, 3019, 203);
end
...
------------------------- Rebirth Reward Starts -------------------------

if (EVENT == 103) then

SelectMsg(UID, 3, -1, 44542, NPC, 3000, 105, 47);
...
(bLevel < 83 or bRebLevel < 4)

then

SelectMsg(UID, 3, -1, 44546, NPC, 10);


else

Check = isRoomForItem(UID, 810934956);
...
REBORN = HowmuchItem(UID, 810934956);

if (REBORN > 0) then


SelectMsg(UID, 3, -1, 44543, NPC, 10);
...
SelectMsg(UID, 3, -1, 44544, NPC, 10);
