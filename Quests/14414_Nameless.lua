...
if EVENT == 305 then
   MonsterCount  = QuestMonsterCount(UID,328,1);
...
if EVENT == 8406 then
    MonsterCount  = QuestMonsterCount(UID, 830,1);
    if  MonsterCount < 0 then
...
if EVENT == 8856 then
    MonsterCount  = QuestMonsterCount(UID, 854,1);
    if  MonsterCount < 0 then
