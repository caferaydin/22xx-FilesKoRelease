...
if (EVENT == 210) then
	...
	if (ITEMA < 2) then
		...
		SelectMsg(UID, 5, savenum, 568, NPC, 41, 207, 27, 193);
	end
end
...
if (EVENT == 298) then
	...
	if (ITEM < 2) then
		...
		SelectMsg(UID, 5, savenum, 1338, NPC, 41, 300, 27, 193);
	end
end
...
if (EVENT == 308) then
	MonsterCount01 = QuestMonsterCount(UID, 114, 1);
	MonsterCount02 = QuestMonsterCount(UID, 114, 2);
	MonsterCount03 = QuestMonsterCount(UID, 114, 3);
	MonsterCount04 = QuestMonsterCount(UID, 114, 4);
...
if (EVENT == 407) then
	...
	if (ITEMB < 2) then
		...
		SelectMsg(UID, 5, savenum, 1232, NPC, 41, 409, 27, 193);
	end
end
