...
if (EVENT == 4016) then
	Check = CheckGiveSlot(UID, 162)
	if (Check) then
		min_count = GetMaxExchange(UID, 162);
		if (min_count > 0) then
			ItemA = HowmuchItem(UID, 389010000);  
