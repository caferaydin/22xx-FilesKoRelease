...
if (EVENT == 195) then
	SelectMsg(UID, 2, 217, 1233, NPC, 28, 196);
end
...
if (EVENT == 201) then
	SelectMsg(UID, 4, 217, 1015, NPC, 22, 202, 23, 193);
end
...
if (EVENT == 205) then
	SaveEvent(UID, 138);
	SelectMsg(UID, 2, 217, 1016, NPC, 21, 193);
end
...
if (EVENT == 210) then
	...
	if (ITEM_COUNT < 3) then
		...
		SelectMsg(UID, 4, 217, 1018, NPC, 41, 214, 27, 193);
	end
end
...
if (EVENT == 347) then -- Nostrum of Magic
	SelectMsg(UID, 2, 323, 385, NPC, 28, 348);
end
...
if (EVENT == 350) then
	SelectMsg(UID, 4, 323, 387, NPC, 22, 351, 23, 193);
end
...
if (EVENT == 352) then
	SaveEvent(UID, 564);
	SelectMsg(UID, 2, 323, 389, NPC, 21, 193);
end
...
if (EVENT == 354) then
	...
	if (ITEM_COUNT1 > 0 and ITEM_COUNT2 > 0 and ITEM_COUNT3 > 1) then
		SelectMsg(UID, 4, 323, 393, NPC, 41, 358, 27, 193);
	end
end
...
if (EVENT == 359) then -- Stamp of Magic Power
	SelectMsg(UID, 2, 325, 500, NPC, 28, 360);
end
...
if (EVENT == 362) then
	SelectMsg(UID, 4, 325, 502, NPC, 22, 363, 23, 193);
end
...
if (EVENT == 364) then
	SaveEvent(UID, 570);
	SelectMsg(UID, 2, 325, 503, NPC, 32, 193);
end
...
if (EVENT == 366) then
	...
	if (ITEM_COUNT1 > 0 and ITEM_COUNT2 > 0 and ITEM_COUNT3 > 0) then 
		SelectMsg(UID, 4, 325, 508, NPC, 41, 370, 27, 193);
	end
end
