...
if (EVENT == 100) then
	SelectMsg(UID, 3, -1, 9170, NPC, 3023, 400, 7345, 160, 7253, 201);
end
...
if (EVENT == 202) then
	Check = CheckGiveSlot(UID, 31511108)  -- Mysterious Ore Item Exchange
   if  Check == true then   
   Roll = RollDice(UID, 8) 
   found = Roll + 31511100
...
if (EVENT == 203) then
	Check = CheckGiveSlot(UID, 31511117)  -- Mysterious Gold Ore Item Exchange
   if  Check == true then   
   Roll = RollDice(UID, 8) 
   found = Roll + 31511109
   RunExchange(UID, found);	 
