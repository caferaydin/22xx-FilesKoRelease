...
if (EVENT == 9547) then
	MonsterCount = QuestMonsterCount(UID, 923, 1);
...
if (EVENT == 9377) then
	MonsterCount = QuestMonsterCount(UID, 901, 1);
	if (MonsterCount < 250) then
...
if (EVENT == 9387) then
	MonsterCount = QuestMonsterCount(UID, 903, 1);
	if (MonsterCount < 250) then
...
if (EVENT == 9397) then
	MonsterCount = QuestMonsterCount(UID, 905, 1);
	if (MonsterCount < 250) then
...
if (EVENT == 9417) then
	MonsterCount = QuestMonsterCount(UID, 908, 1);
	if (MonsterCount < 250) then
...
if (EVENT == 9427) then
	MonsterCount = QuestMonsterCount(UID, 909, 1);
	if (MonsterCount < 250) then
...
if (EVENT == 636) then
	MonsterCount01 = QuestMonsterCount(UID, 1); --Quest Uruk Hai
	MonsterCount02 = QuestMonsterCount(UID, 2); --Quest Stone Golem
	MonsterCount03 = QuestMonsterCount(UID, 3); --Quest Troll Berserker
	MonsterCount04 = QuestMonsterCount(UID, 4); --Quest Apostles
...
if (EVENT == 206) then
	MonsterCount = QuestMonsterCount(UID, 1030, 1);
	if (MonsterCount < 250) then
...
if (EVENT == 216) then
	MonsterCount = QuestMonsterCount(UID, 1032, 1);
	if (MonsterCount < 250) then
...
if (EVENT == 226) then
	MonsterCount = QuestMonsterCount(UID, 1034, 1);
	if (MonsterCount < 250) then
...
if (EVENT == 236) then
	MonsterCount = QuestMonsterCount(UID, 1036, 1);
	if (MonsterCount < 250) then
...
if (EVENT == 246) then
	MonsterCount = QuestMonsterCount(UID, 1038, 1);
	if (MonsterCount < 250) then
