...
if (EVENT == 114) then
	SelectMsg(UID, 4, 22, 6429, NPC, 4161, 116, 4162, 241);
end
...
if (EVENT == 124) then
	SelectMsg(UID, 4, 23, 6438, NPC, 4161, 126, 4162, 241);
end
...
if (EVENT == 286) then
	SelectMsg(UID, 4, 21, 4272, NPC, 4161, 287, 4162, 241);
end
...
if (EVENT == 361) then 
	...
	if (ITEM_COUNT < 1500000) then
		SelectMsg(UID, 2, 19, 4260, NPC, 10, 241);
	else
		SelectMsg(UID, 4, 19, 4258, NPC, 22, 362, 23, 241);
	end
end
...
if (EVENT == 363) then
	...
	if (ITEM_COUNT < 350000) then
		SelectMsg(UID, 2, 20, 4261, NPC, 10, 241);
	else
		SelectMsg(UID, 4, 20, 4259, NPC, 22, 364, 23, 241);
	end
end
